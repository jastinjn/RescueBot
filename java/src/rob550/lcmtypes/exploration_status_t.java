...
public final class exploration_status_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(rob550.lcmtypes.exploration_status_t.class))
            return 0L;
 
        classes.add(rob550.lcmtypes.exploration_status_t.class);
    ...
    public static rob550.lcmtypes.exploration_status_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        rob550.lcmtypes.exploration_status_t o = new rob550.lcmtypes.exploration_status_t();
    ...
    public rob550.lcmtypes.exploration_status_t copy()
    {
        rob550.lcmtypes.exploration_status_t outobj = new rob550.lcmtypes.exploration_status_t();
